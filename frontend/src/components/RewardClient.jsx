...
export default function RewardClient({ coupon }) {
      ...
      >
        <div style={{ textAlign: "center", padding: 32, maxWidth: 400 }}>
          ...
          >
            ...
            <strong style={{ color: "white" }}>₹{coupon.value}</strong> to your
            account within{" "}
      ...
      <div className="rw-header">
        <div
          style={{
            ...
            height: 30,
            background:
              "linear-gradient(135deg, var(--brand-600), var(--purple-600))",
            borderRadius: 8,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
        ...
        <div className="rw-card">
          <>
            <div style={{ textAlign: "center", marginBottom: 28 }}>
              ...
              >
                Enter your preferred payment details below so we can securely
                credit your account.
              </p>
            </div>
            ...
            >
              ...
              {accountType === "BANK_ACCOUNT" ? (
                ...
                >
                  ...
                  <label className="rw-label" style={{ marginTop: 10 }}>
                    Account Number *
                  </label>
                  <input
                    type="password"
