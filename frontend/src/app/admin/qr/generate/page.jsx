...
export default function GenerateQRCodes() {
  ...
  const [latestQrs, setLatestQrs] = useState([]);
  ...
  const handleGenerate = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        const data = await res.json();
        setSuccess(
          `Success! ${count} coupons worth ₹${value} each have been generated.`,
        );
  ...
  const handlePrint = (items, type) => {
    ...
    items.forEach((qData) => {
      const canvas = document.getElementById(`qr-batch-${qData._id}`);
      if (canvas && qData) {
  ...
  return (
    ...
    >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              >
                Create new cashback coupons in bulk
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <div style={{ width: "100%", maxWidth: 700 }}>
            <div
              style={{
                background:
                  "linear-gradient(140deg,#0f0c29 0%,#302b63 45%,#24243e 100%)",
                borderRadius: 20,
                marginBottom: 22,
                position: "relative",
                overflow: "hidden",
                boxShadow: "0 16px 48px rgba(15,12,41,0.4)",
              }}
            >
              <div
                style={{
              ...
              <div style={{ position: "relative", zIndex: 1, padding: "40px" }}>
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Create secure batches of QR coupons instantly.
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => handlePrint(lastBatch, printFormat)}
                      style={{
                        display: "inline-flex",
                        alignItems: "center",
                        gap: 8,
                ...
                <div style={{ maxHeight: 250, overflowY: "auto" }}>
                  <table style={{ width: "100%", borderCollapse: "collapse" }}>
                    ...
                    >
                      ...
                      >
                        <th style={{ padding: "12px 24px", fontWeight: 700 }}>
                          QR Code
                        </th>
                        <th style={{ padding: "12px 24px", fontWeight: 700 }}>
                          Value
                    ...
                    {latestQrs.map((qr) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td
                            style={{ padding: "14px 24px", color: "#64748b" }}
                          >
                            {isToday ? (
                              <span
                                style={{
      ...
      <div style={{ display: "none" }}>
        {Array.from(
          new Map(
            [...lastBatch, ...latestQrs].map((qr) => [qr._id, qr]),
          ).values(),
        ).map((qr) => (
          <QRCodeCanvas
            key={`batch-${qr._id}`}
