...
export default function AdminDashboard() {
  ...
  const conversion =
    stats?.totalQRs > 0
      ? ((stats.usedQRs / stats.totalQRs) * 100).toFixed(1)
      : "0.0";
            ...
            <div style={{ position: "relative" }} ref={profileRef}>
              <button
                ...
                style={{
                  ...
                  border: "1px solid",
                  borderColor: profileOpen ? "#e5e7eb" : "transparent",
                  borderRadius: 8,
          ...
          {loading ? (
            ...
            <>
              ...
              <div
                style={{
                  background:
                    "linear-gradient(135deg, #1e1b4b 0%, #312e81 35%, #4338ca 70%, #6d28d9 100%)",
                  borderRadius: 20,
                  padding: "28px 32px",
                  marginBottom: 24,
                  display: "flex",
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                    {[
                      {
                        icon: QrCode,
                        label: `${available} Coupons Available`,
                        bg: "rgba(99,102,241,0.25)",
                        border: "rgba(165,180,252,0.3)",
                      },
                      {
                        icon: Clock,
                        label: `${stats?.pendingCount ?? 0} Claims Pending`,
                        bg: "rgba(245,158,11,0.2)",
                        border: "rgba(253,230,138,0.3)",
                      },
                      {
                        icon: IndianRupee,
                        label: `₹${stats?.totalPayout ?? 0} Total Payout`,
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    value: available,
                    trend:
                      available > 0 ? "Ready to distribute" : "Generate more",
                    trendUp: available > 0,
                    iconBg: "#fffbeb",
                    iconColor: "#d97706",
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          padding: "3px 8px",
                          borderRadius: 99,
                          background: trendUp ? "#ecfdf5" : "#f9fafb",
                          color: trendUp ? "#059669" : "#9ca3af",
                          fontSize: "0.7rem",
                          fontWeight: 700,
                        }}
                      >
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        Status breakdown of all submissions
                      </div>
                    </div>
                    <Link
                      href="/admin/submissions"
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  background: color,
                                  borderRadius: 99,
                                  width: `${stats?.pendingCount + stats?.approvedCount + stats?.paidCount + stats?.rejectedCount > 0 ? (value / (stats?.pendingCount + stats?.approvedCount + stats?.paidCount + stats?.rejectedCount)) * 100 : 0}%`,
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                      {[
                        ...
                        ({ href, icon: Icon, label, primary, external }) => {
                          const style = {
                            display: "inline-flex",
                            alignItems: "center",
                            gap: 6,
                ...
                {!stats?.recentClaims || stats.recentClaims.length === 0 ? (
                  <div style={{ padding: "48px 20px", textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: "0.78rem", color: "#9ca3af" }}>
                      When users submit claims, they'll appear here.
                    </div>
                  </div>
                ) : (
