...
const features = [
  {
    ...
    desc: "Cryptographically unique QR codes that self-invalidate after a single use.",
  },
  {
    icon: Zap,
    title: "Real-Time Verification",
    desc: "Review and approve cashback claims the moment they arrive.",
  },
  {
    icon: BarChart3,
    title: "Analytics & CSV Export",
    desc: "Track every payout, conversion rate, and distribution metric.",
  },
];
    ...
    <div className="login-page">
      ...
      <div className="login-left">
        ...
        <h1 className="login-headline">
          Manage your
          <br />
          rewards with <em>confidence.</em>
        </h1>
        <p className="login-tagline">
          A complete platform to generate, distribute, and verify QR coupon
          cashback claims — all in one place.
        </p>
