          ...
          <div className="login-feature">
            ...
            <div>
              ...
              <div className="login-feature-desc">
                Required to verify your identity and authorize the change.
              </div>
            </div>
          </div>
        </div>
          ...
          {!success && (
            <form className="login-form" onSubmit={handleReset}>
              ...
              <div className="form-field">
                ...
                <div
                  style={{ fontSize: 13, color: "var(--text-3)", marginTop: 8 }}
                >
                  Default key is <strong>hyperpass</strong> unless set in
                  environment.
                </div>
              </div>
