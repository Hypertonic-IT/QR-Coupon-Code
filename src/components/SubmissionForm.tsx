...
export default function SubmissionForm({ couponId, uniqueCode }: SubmissionFormProps) {
    ...
    if (success) {
        return (
            <div className="glass animate-fade-in" style={{ padding: '2rem', textAlign: 'center', borderColor: 'var(--success)' }}>
    ...
    return (
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>Mobile Number</label>
                <input name="mobile" className="input" type="tel" placeholder="+91 00000 00000" required />
            </div>
            ...
            <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>Details (UPI ID / Account Number / UPI Number)</label>
                <input name="accountValue" className="input" placeholder="Enter details here" required />
            </div>

            <div>
                <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>Payment Screenshot</label>
                <div
                    style={{
                ...
                >
                    {screenshotPreview ? (
                        ...
                        <>
                            ...
                            <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem' }}>Upload Screenshot</p>
                        </>
                    )}
                    <input
                        id="screenshot-input"
