...
const actions = [
    { label: 'Export CSV', href: '/api/admin/export-csv', icon: Download, external: true },
];
        ...
        <nav className="sidebar">
            ...
            <div className="sidebar-group">
                ...
                {actions.map(({ label, href, icon: Icon, external }) => (
                    external ? (
                        <a key={label} href={href} target="_blank" rel="noreferrer" className="sb-item">
                            <span className="sb-icon"><Icon size={16} /></span>
                            {label}
                        </a>
                    ) : (
            ...
            <div className="sidebar-bottom">
                ...
                <button onClick={handleLogout} className="sb-item" style={{ color: '#ef4444' }}>
                    <span className="sb-icon"><LogOut size={15} /></span>
                    Sign Out
                </button>
            </div>
        </nav>
